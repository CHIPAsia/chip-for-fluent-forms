 ...
 *
 */
if ( ! class_exists( 'CHIPFLUENT_Field_color' ) ) {
  class CHIPFLUENT_Field_color extends CHIPFLUENT_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="chipfluent-color"'. $default_attr . $this->field_attributes() .'/>';
