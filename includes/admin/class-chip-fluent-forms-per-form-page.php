 ...
 * per-payment-method subkeys, so the per-form customize hook in
 * class-chip-fluent-forms-form-settings.php has no visible UI on the
 * form editor. To give the merchant a working way to set per-form
 * credentials (Brand ID / Secret Key / Payment Mode / Due Strict /
 * Whitelist), this class registers a standalone WP admin submenu
 * under the Fluent Forms menu.
 *
 * URL:
 ...
 *
 * The page persists via Chip_Fluent_Forms_Settings::save_form() so the
